module.exports = function getDefaults(grunt, _, path, fs, merged, glob) { // jshint ignore: line
  ...
  defaults.hooks.e2eCapabilities = false;
  ...
  merged(function(config) {
    var bowerPkg = require(config.files.bower);
    ...
    config._.files.vendorAll = wiredep({
      bowerJson: bowerPkg,
      dependencies: true,
